...
import { Bell, ChevronDown, UserCircle, AlertTriangle, CheckCircle } from 'lucide-react'; // Added icons
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={notificationsRef}>
            <button
              ...
              className="p-2 rounded-full hover:bg-gray-800 relative text-gray-400 hover:text-white"
            ...
            {notificationsOpen && (
              <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-gray-800 rounded-md shadow-lg z-20 border border-gray-700">
                ...
                <div className="divide-y divide-gray-700 max-h-60 overflow-y-auto">
                  {notifications.length > 0 ? notifications.map(notif => (
                    <a key={notif.id} href="#" className="flex items-start p-3 hover:bg-gray-700 transition duration-150 ease-in-out">
          ...
          <div className="relative" ref={userMenuRef}>
            <button
              ...
              className="flex items-center space-x-2 hover:bg-gray-800 p-1 rounded-md"
            ...
            {userMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-md shadow-lg z-20 border border-gray-700 py-1">
                <a href="#" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white">Mon profil</a>
                <a href="/settings" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white">Paramètres</a>
